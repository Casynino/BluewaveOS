...
CREATE TABLE "Container" (
    ...
    "originPort" TEXT DEFAULT 'Foshan',
...
CREATE TABLE "ShipmentSchedule" (
    "id" TEXT NOT NULL,
    "origin" TEXT NOT NULL DEFAULT 'Foshan',
...
CREATE TABLE "CompanySetting" (
    ...
    "name" TEXT NOT NULL DEFAULT 'BlueWave Cargo',
    "tagline" TEXT DEFAULT 'From sourcing to delivery',
    "email" TEXT,
    "phone" TEXT,
    "altPhone" TEXT,
    "whatsapp" TEXT,
