...
export const MARKETS: SeedMarket[] = [
  {
    ...
    tips: [
      ...
      "Goods bought here travel by road to our Foshan warehouse and sail from there to Dar es Salaam.",
    ],
  },
  {
  ...
  },
  {
    ...
    tips: [
      "Goods bought in Shenzhen come by road to our Foshan warehouse before they sail.",
