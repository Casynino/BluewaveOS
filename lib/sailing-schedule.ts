...
/**
 * The moment the Foshan counter stops taking cargo for a Friday deadline.
 *
 ...
 * arrives at eight on Friday evening in Foshan made the boat, and a
...
export type Sailing = {
   ...
   */
  key: string;
  /** Last day Foshan accepts cargo. Friday. */
  cargoDeadline: Date;
