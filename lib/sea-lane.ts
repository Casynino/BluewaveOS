 ...
 * THE LANE, DRAWN ONCE.
 *
 * Foshan to Dar es Salaam is not a straight line and drawing it as one puts
 ...
 * the run down the estuary out of Foshan, which is the river, the curve
 * never touches land.
 *
 ...
 *
 * `fraction` is 0 at Foshan and 1 at Dar. The angle is in degrees, measured
...
export const LANE_PORTS = [
  { id: "gz", label: "FOSHAN", lon: 113.26, lat: 23.13, anchor: "middle", dy: -13 },
...
export const FOSHAN = chartPoint(113.26, 23.13);
