 ...
 *
 * Everything the Foshan floor needs to find a factory and know what it is
  ...
  return {
    ok:
      data.type === "CUSTOMS_CLEARANCE"
        ? `${L("Thank you. Your reference is")} ${request.reference}. ${L("BlueWave Cargo will review the shipment and come back to you with a clearance quotation.")}`
