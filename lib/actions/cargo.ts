...
/*
  ...
  A consignment now begins the moment Foshan has it in front of them, and
...
/**
 * The Foshan floor says the boxes are here.
 *
 ...
 *
 * Whichever floor holds the cargo corrects its lines — Foshan before Dar
...
/**
 * BlueWave Cargo's signature that the boxes were received in Foshan.
 *
 ...
 *
 * The warehouse is recorded from the uploader's own posting, so a Foshan
...
export async function receiveNewCargo(
  ...
  */
  ...
  /*
    ...
    A clerk in Foshan is standing in the Foshan warehouse; asking which
  ...
  */
  /*
    ...
    Foshan types the goods in Chinese; Dar reads them in English. The
  ...
  try {
    result = await prisma.$transaction(async (tx) => {
      ...
      /*
        ...
        Matched case-insensitively and on the whole name: "Foshan Leather
        ...
        data: [
          ...
          },
          {
            ...
            reason: data.paperReceiptNo
              ? `Received at Foshan against note ${data.paperReceiptNo}`
              : "Received at the Foshan warehouse",
            actorId: actor.id,
