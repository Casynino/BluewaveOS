...
export async function receiveInDar(
  ...
  /*
    ...
    still in Foshan or on the water, and a Dar receiving row for it would put
  ...
  */
  ...
  /* A damage claim is argued from the Foshan photograph and the Dar one of
 ...
 * Foshan sent them, and making a clerk open a form to retype four figures
 ...
 *
 * Foshan types a consignment when it takes it in, and most arrive typed. The
