...
/**
 * CARGO WITH NO SAILING ON RECORD, WAITING FOR A PRICE.
 *
 ...
 *
 * Two kinds sit here. Goods Foshan has measured and nobody has loaded yet —
 * Finance prices from China's figures and waiting for a container is a queue
 * nobody works — and consignments already standing in Dar when this system
 * started, which have a receiving row and no container line.
 *
 * Same test as a container's "waiting for prices": measured somewhere, and nothing
