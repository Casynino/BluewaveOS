...
/**
 * A container still in Foshan: open, filling, loaded or sealed and waiting
 ...
 */
const LOADING_IN_FOSHAN: ContainerStatus[] = ["OPEN", "LOADING", "LOADED", "SEALED"];
  ...
  const attention: AttentionItem[] = (
    [
      ...
      },
      {
        ...
        count: staleInChina,
        tone: "warn",
        title: count(staleInChina, "waiting in Foshan more than a fortnight"),
      ...
      },
      {
        ...
        count: heldInChina,
        tone: "warn",
        title: count(heldInChina, "on hold in Foshan"),
      ...
      },
      {
        ...
        detail: t(locale, "Booked in at Dar with fewer packages than Foshan recorded, and nobody has reviewed the gap."),
      ...
      },
      {
        ...
        tone: "neutral",
        title: count(position.ready, "ready, not collected"),
  ...
  */
  ...
  const desks: DeskPulse[] = [
    ...
    },
    {
      ...
      detail: count(position.ready, "ready and waiting to be collected"),
  ...
  return {
    ...
    operations: {
      ...
      registeredByMonth,
      containersLoading: byContainer(LOADING_IN_FOSHAN),
