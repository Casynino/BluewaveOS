...
/** "INV-2026-000016" becomes "INV-2026-000016 (BW0061)" the first time it appears. */
...
const ACTION_LABELS: Record<string, string> = {
  ...
  "cargo.arrivedDar": "Arrived in Dar",
  "cargo.readyForPickup": "Ready for pickup",
  "cargo.readyForRelease": "Marked ready for pickup",
  "cargo.clear": "Marked cleared (retired step)",
  ...
  "invoice.reprice.undo": "Re-price taken back",
  "invoice.reprice.measurement": "Draft re-priced from the measurements",
  "invoice.rate": "Invoice rate changed",
  "invoice.rate.undo": "Rate change taken back",
