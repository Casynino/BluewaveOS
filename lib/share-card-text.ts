 ...
 *
 * What WhatsApp prints under the picture when somebody pastes a BlueWave Cargo
...
export const SHARE_CARD_TEXT = {
  title: "BlueWave Cargo — Shipping from China to Tanzania",
  description:
    "Fast sea freight and China sourcing to Dar es Salaam. Track your cargo any time — From sourcing to delivery.",
