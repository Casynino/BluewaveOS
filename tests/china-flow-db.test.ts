...
/**
 * The Foshan end of the chain, against the real database, inside a
...
/**
 * One container in Foshan with two customers' cargo in it, measured and
...
describe("what Foshan measures is kept as Foshan measured it", () => {
