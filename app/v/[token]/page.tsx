 ...
 *
 * Answers one question for whoever is holding the paper: did BlueWave Cargo issue
...
export default async function VerifyInvoicePage({ params }: { params: Promise<{ token: string }> }) {
  ...
  return (
    <main className="grid min-h-dvh place-items-center bg-[#0a3350] px-5 py-10">
      <div className="w-full max-w-md overflow-hidden rounded-3xl bg-white shadow-2xl">
        <div className="flex items-center gap-3 bg-[#0a3350] px-6 py-5 text-white">
          <span className="grid size-12 place-items-center rounded-xl bg-white p-1">
            <Image src="/brand/bluewave-cargo.png" alt="" width={44} height={44} />
          </span>
          <div>
            <p className="text-lg font-extrabold uppercase tracking-[0.12em]">BlueWave Cargo</p>
          ...
          {genuine && invoice && balance ? (
            <>
              <p className="flex items-center gap-2 text-lg font-bold text-emerald-700">
                ...
                Genuine BlueWave Cargo invoice
              </p>
              ...
              <Link
                ...
                className="mt-5 inline-flex w-full items-center justify-center rounded-full bg-[#ea4a5c] px-5 py-3 text-sm font-semibold text-white"
              >
                Track this cargo
              </Link>
            </>
            ...
            <>
              ...
              <p className="mt-3 text-sm text-neutral-600">
                This code was not issued by BlueWave Cargo, or the invoice is not final. Do not pay against it — call us to
                check.
              </p>
            </>
          )}
