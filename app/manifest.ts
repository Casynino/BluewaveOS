...
/**
 * BLUEWAVE CARGO AS AN APP ON THE PHONE.
 *
...
export default function manifest(): MetadataRoute.Manifest {
  return {
    name: "BlueWave Cargo",
    short_name: "BlueWave Cargo",
    description: "Sea freight from Foshan to Dar es Salaam — track, book, pay and run the warehouse.",
    id: "/",
    start_url: "/login",
    scope: "/",
    display: "standalone",
    orientation: "portrait",
    background_color: "#0a3350",
    theme_color: "#0a3350",
