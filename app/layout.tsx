...
export const metadata: Metadata = {
  ...
  title: {
    default: "BlueWave Cargo — Sea freight from China to Tanzania",
    template: "%s · BlueWave Cargo",
  },
  description:
    "Loose cargo and full container sea freight from Foshan to Dar es Salaam. Track your cargo, calculate CBM and see live shipping rates.",
