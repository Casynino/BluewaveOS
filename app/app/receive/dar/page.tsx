...
async function inboundContainers() {
  return prisma.container.findMany({
    /*
      ...
      Foshan was invisible to Dar until the day it left. Dar plans floor
      space and labour weeks ahead; "what is coming and roughly when" is the
      question, and a box already half full in Nanhai is part of the answer.
            ...
            <TableBody>
              {rows.map((container) => {
                ...
                const waited = since
                  ...
                  : null;
                /* What actually came off, against what Foshan sent. */
...
export default async function DarReceivePage({
  ...
  */
  ...
  /* Still in Foshan: sealed and waiting for a vessel, or still taking
    ...
    <div className="space-y-6">
      ...
      <StatStrip
        chips={[
          ...
          { label: "Still in Foshan", value: String(inChina.length), icon: Warehouse },
      ...
      */}
      ...
      {/*
        ...
        Everything still to do: on the water, being filled in Foshan, or
