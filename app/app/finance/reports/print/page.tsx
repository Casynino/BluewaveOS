...
export async function generateMetadata({
  ...
  return { title: { absolute: `BlueWave Cargo - ${REPORTS[p.report]} - ${p.reportRange.label}` } };
}
      ...
      <article className="rounded-lg border bg-white p-8 text-black print:border-0 print:p-0">
        <header className="mb-6 flex items-start justify-between gap-4 border-b border-black pb-4">
          <div className="flex items-center gap-3">
            <Image src="/brand/bluewave-cargo.png" alt="" width={44} height={44} className="object-contain" />
            <div>
              <p className="font-bold uppercase tracking-wider">BlueWave Cargo</p>
