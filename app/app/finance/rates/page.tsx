...
/**
 * THE RATE BOOK — WHAT BLUEWAVE CARGO CHARGES, AND THE RATE IT CHARGES IT AT.
 *
...
export default async function RateBookPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title={T("Rate book")}
        description={T("Every figure BlueWave Cargo quotes comes from this page — the rate for each kind of goods, customers' agreed rates and today's exchange rate. Change it here and the next bill follows; a bill already raised keeps what it was priced at.")}
      />
