    ...
    <div className="space-y-6">
      ...
      <Card className="flex items-start gap-3 p-4 text-sm">
        ...
        <p className="text-muted-foreground">
          {t(
            locale,
            "Wherever the goods are bought, they come to our Foshan warehouse and sail from there to Dar es Salaam — roughly 28 to 30 days at sea. Sea freight is charged on volume at the rate for the cargo type, so the packed size of what they buy matters as much as its price."
          )}
        </p>
      </Card>
