...
/**
 * One of the four "today" boxes, as on the air side: what the Foshan desk
...
export default async function DashboardPage() {
  ...
  /* The Foshan desk gets its own page below the shared top. Manager and
    ...
    <div className="space-y-8">
      ...
      <section>
        ...
        {/* The four "today" boxes sit under the worry list, as on the air
            side: the day's work in four numbers, counted from Foshan's
            midnight. */}
        {chinaHome && floor ? (
        ...
        <>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
              <Card>
                <CardHeader>
                  <CardTitle className="text-base">{t(locale, "What is in Foshan")}</CardTitle>
              ...
              <Card>
                <CardHeader>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {t(locale, "From the day it was registered in Foshan")}
                  </p>
                </CardHeader>
              ...
              <Card className="lg:col-span-3">
                <CardHeader className="flex-row items-start justify-between gap-3 space-y-0">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Cubic metres taken in at the Foshan desk,{" "}
          ...
          <section>
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
              <Card>
                <CardHeader>
                  <CardTitle className="text-base">Open in Foshan</CardTitle>
                  <p className="text-sm text-muted-foreground">
