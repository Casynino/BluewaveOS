...
export default async function PortalPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <header className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#0a3350] via-[#0e3a5f] to-[#1d6fa3] p-5 text-white shadow-raised sm:p-7">
          ...
          {recent.length === 0 ? (
            <Card className="p-6 text-center">
              ...
              <p className="mx-auto mt-1 max-w-sm text-sm text-muted-foreground">
                {t(locale, "Send your first shipment to BlueWave Cargo and track everything from here.")}
              </p>
              ...
              <Card className="p-4">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <Badge tone={current.departedAt ? "progress" : "neutral"}>
                    {t(locale, current.departedAt ? "At sea" : "Loading in Foshan")}
                  </Badge>
                </div>
