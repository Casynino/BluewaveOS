...
export type CheckInRow = {
  ...
  cargoTypes: string[];
  photos: number;
  /** What Foshan recorded, or what was declared if they recorded nothing. */
  ...
  damaged: boolean;
  hasCase: boolean;
  /** Put on this manifest at Dar, not loaded into the box in Foshan. */
  added: boolean;
  china: {
 ...
 * came exactly as Foshan sent them, so the tick means "what China recorded is
  ...
  return (
    <>
      ...
      >
        ...
        <td className="hidden px-3 py-2 md:table-cell">
          {/* Not on the paper Foshan sealed. It is said on the row as well
