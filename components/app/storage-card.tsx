...
export function StorageCard({
  ...
  /** The day the container landed — when the clock started — formatted. */
  since: string;
    ...
    >
      ...
      <div className="border-b px-4 py-3">
        ...
        <p className="mt-1 text-xs text-muted-foreground">
          {waived
            ? `landed ${since} · storage taken off: ${waived}`
            : `landed ${since} · added to the bill by itself, a day at a time, until pickup`}
        </p>
      </div>
