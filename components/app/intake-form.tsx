  ...
  return (
    <form action={action} className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          {/*
            ...
            the boxes in Foshan is the customer's own name nine times out of
      ...
      */}
      ...
      <p className="text-xs text-muted-foreground">
        {t("Confirming creates the tracking number and the delivery note, and tells the customer their goods have arrived in Foshan.")}
      </p>
    </form>
  );
}
