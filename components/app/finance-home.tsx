...
export async function FinanceHome() {
  ...
  const items: AttentionItem[] = [
    ...
    ...(notesOut.length ? [{ id: "notes", group: "Pickup", count: notesOut.length, tone: "neutral" as const, title: `${notesOut.length} ready, not collected`, detail: "Paid for and released. The cargo is still on our floor waiting for the customer to turn up.", href: "/app/finance/pickup-notes", meta: "already paid for" }] : []),
