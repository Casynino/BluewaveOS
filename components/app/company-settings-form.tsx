    ...
    <form ref={formRef} action={action} className="space-y-6">
      ...
      >
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <Field
            id="chinaEntity"
            label={t(locale, "Foshan company")}
            hint={t(locale, "The legal company that receives in Foshan.")}
          >
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <Panel
          ...
          hint={t(
            locale,
            "Customers forward this to their supplier, so keep it in the script a driver in Nanhai can read."
          )}
        >
      ...
      >
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <Field id="instagram" label={t(locale, "Instagram handle")}>
            <Input id="instagram" name="instagram" placeholder="bluewave_cargo" defaultValue={settings.instagram} className="h-11" />
          </Field>
        </div>
      </Panel>
