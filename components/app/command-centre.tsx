    ...
    <div className="space-y-6">
      <DeskHero
        ...
        subtitle={t(
          locale,
          user.role === "ADMIN"
            ? "Here is what is happening at BlueWave Cargo today."
      ...
      <section>
        <BandHeading
          ...
          hint={t(locale, "Everything the business is carrying, Foshan to the counter.")}
          ...
          <BentoCard>
            ...
            <PipelineStrip
              stages={[
                {
                  key: "loading",
                  label: t(locale, "Loading in Foshan"),
