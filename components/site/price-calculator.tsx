      ...
      <div className="flex flex-col p-5 sm:p-8">
        ...
        <div className="mt-8 hidden items-center gap-4 rounded-2xl bg-surface-2 p-4 sm:flex lg:mt-auto">
          <svg aria-hidden viewBox="0 0 64 52" className="h-12 w-14 shrink-0 text-brand">
            ...
            <path d="M4 22v18M60 22v18M36 4h18" stroke="#ea4a5c" strokeWidth="2" strokeLinecap="round" strokeDasharray="2 3" />
          </svg>
      ...
      <div id="calc-answer" aria-live="polite" className="relative isolate flex scroll-mt-20 flex-col overflow-hidden bg-ink p-5 text-white sm:p-8">
        ...
        {service === "FCL" ? (
          <div className="my-auto">
            ...
            <p className="mt-2 text-sm text-white/60">{t(locale, "The whole container, Foshan to Dar es Salaam.")}</p>
            <Link
  ...
  return (
    <div>
      <p className="mb-3 flex items-center gap-3 font-display text-lg font-bold tracking-tight">
        <span className="tnum grid size-8 place-items-center rounded-full bg-gradient-to-br from-signal to-rose-600 text-sm text-white">
          {n}
        </span>
        {title}
      </p>
