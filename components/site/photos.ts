...
export const PHOTOS = {
  ...
  chinaNight: { src: guangzhouNight, alt: "Guangzhou's skyline and river at night", credit: "Wally Yang" },
  chinaDusk: { src: guangzhouDusk, alt: "Guangzhou at dusk", credit: "Qingbao Meng" },
