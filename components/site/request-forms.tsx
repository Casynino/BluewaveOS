    ...
    <PublicForm action={submitQuoteRequest} submitLabel={t(locale, "Request a quote")}>
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="space-y-2">
          ...
          <Input id="q-originCity" name="originCity" maxLength={200} defaultValue="Foshan" />
        </div>
        <div className="space-y-2">
 ...
 *
 * Everything the Foshan floor needs before it sends a van: who is asking,
      ...
      <Section title={t(locale, "Where in China")}>
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <Input id="p-city" name="city" maxLength={200} defaultValue="Foshan" />
          </div>
          <div className="space-y-2">
      ...
      {freight ? (
          ...
          <Section title={t(locale, "Route and readiness")}>
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input id="b-originCity" name="originCity" maxLength={200} defaultValue="Foshan" />
              </div>
              <div className="space-y-2">
        ...
        <Section title={t(locale, "The shipment to clear")}>
          ...
          <p className="mt-4 rounded-md bg-secondary px-3 py-2 text-xs text-muted-foreground">
            {t(
              locale,
              "BlueWave Cargo reviews the shipment and its documents and comes back to you with a clearance quotation. Send the bill of lading, the packing list and the invoice on WhatsApp with your reference once you have it."
            )}
          </p>
        </Section>
      )}
